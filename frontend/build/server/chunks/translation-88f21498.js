let translation = {
  ...
  areYouSureYouWantToDel: {
    ...
    ar: "هل انت متاكد من انك تريد حذف"
  },
  "?": {
    en: "?",
    ar: "؟"
  ...
  qrCode: {
    en: "Qr Code",
    ar: "رمز الاستجابة السريع"
  },
  studentQrCode: {
    en: "Student's Qr Code",
    ar: "رمز الاستجاية السريع (QR) الخاص بالطالب "
  },
  download: {
    en: "Download",
    ar: "تحميل"
  ...
  signInToContinue: {
    ...
    ar: "قم بتسجيل الدخول للمتابعة إلى"
  },
  username: {
    en: "Username",
    ar: "اسم المستخدم"
  ...
  enterUsernameEmailOrPhone: {
    en: "Enter username, email or phone",
    ar: "ادخل اسم المستخدم, البريد الالكتروني او رقم الهاتف"
  },
  forgotPassword: {
    en: "Forgot password",
    ar: "نسيت كلمة المرور"
  ...
  simplePricingQuote: {
    en: "Simple pricing. No hidden fees. Advanced features for you business.",
    ar: "تسعير بسيط. لا رسوم خفية. ميزات متقدمة لعملك."
  },
  monthly: {
    en: "Monthly",
    ar: "شهري"
  ...
  proccessingPayment: {
    en: "Proccessing Payment",
    ar: "معالجة الدفع"
  },
  orderCompleted: {
    en: "Thank you ! Your Order is Completed",
    ar: "شكرًا لك ! اكتمل طلبك"
  },
  goBackTo: {
    en: "Go back to",
    ar: "ارجع الى"
  ...
  pleaseFillInfo: {
    en: "Please fill all information below",
    ar: "يرجى ملء جميع المعلومات أدناه"
  },
  userNewAddress: {
    en: "Use a New Address",
    ar: "استعمل عنوان جديد"
  },
  address: {
    en: "Address",
    ar: "العنوان"
  ...
  picGuideCamera: {
    en: `   <h6 class="fw-semibold mb-3 text-info">To Capture the Image</h6>
        <ol class="text-muted vstack gap-2 mb-4 text-info">
            ...
            <li><span class="text-info fw-semibold">Background: </span>Use a simple and uncluttered background</li>
    ...
    ar: `  <h6 class="fw-semibold mb-3 text-info">لالتقاط الصورة</h6>
        <ol class="text-muted vstack gap-2 mb-4 text-info">
            <li> <span class="text-info fw-semibold">الإضاءة: </span>التقط الصورة في مكان جيد الإضاءة وتجنب الضوء القوي المباشر</li>
            <li><span class="text-info fw-semibold">الخلفية: </span>استخدم خلفية بسيطة وغير مزدحمة </li>
  ...
  picGuideUpload: {
    ...
    ar: `
        ...
        <ol class="text-muted vstack gap-2 mb-4 text-info">
            ...
            <li><span class="text-info fw-semibold">تحقق من الوضوح: </span>تأكد من أن الوجه في الصورة واضح وغير مشوش</li>
...
//# sourceMappingURL=translation-88f21498.js.map
