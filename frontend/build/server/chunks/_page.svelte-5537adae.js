import { c as create_ssr_component, v as validate_component, f as each, i as createEventDispatcher, h as add_attribute, e as escape, b as subscribe } from './ssr-69d45533.js';
...
const CartProduct = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="card product"><div class="card-body"><div class="row gy-3"><div class="col-sm-auto"><div class="avatar-lg bg-light rounded p-1"><img${add_attribute("src", product.image.full_path, 0)} alt="" class="img-fluid d-block"></div></div> <div class="col-sm"><h5 class="fs-14 text-truncate"><a href="ecommerce-product-detail.html" class="text-body">${escape(product.name)}</a></h5> <ul class="list-inline text-muted"><li class="list-inline-item">Category : <span class="fw-medium">${escape(product.category == null ? "no category" : product.category.name)}</span></li></ul> <div class="input-step step-primary"><button type="button" class="minus" data-svelte-h="svelte-jzgjqt">-</button> <input type="number" class="product-quantity" min="0" oninput="this.value = Math.abs(this.value)"${add_attribute("value", product.qty, 0)}> <button type="button" class="plus" data-svelte-h="svelte-suctdq">+</button></div></div> <div class="col-sm-auto"><div class="text-lg-end"><p class="text-muted mb-1" data-svelte-h="svelte-2y45sf">Item Price:</p> <h5 class="fs-14">${escape(product.currentPrice)} SAR</h5></div></div></div></div>  <div class="card-footer"><div class="row align-items-center gy-3"><div class="col-sm"><div class="d-flex flex-wrap my-n1"><div><a href="#" class="d-block text-body p-1 px-2" data-svelte-h="svelte-1exe4tu"><i class="ri-delete-bin-fill text-muted align-bottom me-1"></i> Remove</a></div></div></div> <div class="col-sm-auto"><div class="d-flex align-items-center gap-2 text-muted"><div data-svelte-h="svelte-lxj2re">Total :</div> <h5 class="fs-14 mb-0">${escape(product.currentPrice * product.qty)} SAR</h5></div></div></div></div> </div>`;
});
  ...
  {
    {
      subtotal = productsList.reduce(
        (total2, product) => {
          return total2 + product.currentPrice * product.qty;
        },
        0
      );
    }
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    $$settled = true;
    $$rendered = `<div class="row"><div class="col-lg-12"><div class="card"><div class="card-header align-items-center d-flex"><h4 class="card-title mb-0 flex-grow-1" data-svelte-h="svelte-177umtu">Orders Managment</h4> <div class="flex-shrink-0"><button type="button" data-bs-toggle="modal" data-bs-target="#addProductToCartModal" class="btn btn-primary waves-effect waves-light" data-svelte-h="svelte-1smpc22"><i class="ri-add-line align-bottom me-1"></i>Add Product</button> ${validate_component(AddProductToCart, "AddProductToCart").$$render($$result, {}, {}, {})}</div> </div> </div></div></div> <div class="row mb-3"><div class="col-xl-8">${each(productsList, (product, i) => {
    ...
    })}</div>  ${validate_component(OrderSummary, "OrderSummary").$$render($$result, { productsList }, {}, {})}</div>`;
  } while (!$$settled);
  return $$rendered;
});

export { Page as default };
//# sourceMappingURL=_page.svelte-5537adae.js.map
