import { c as create_ssr_component, b as subscribe, h as add_attribute, e as escape, v as validate_component, s as setContext, f as each, g as getContext } from './ssr-69d45533.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  school = data.studentsResponse.data.school;
  studentsPagination = data.studentsResponse.pagination;
  $$unsubscribe_page();
  return `<div class="row"${add_attribute("this", studentsPage, 0)}><div class="col-lg-12"><div class="card"><div class="card-header align-items-center d-flex"><div class="d-flex gap-2 align-items-center flex-grow-1"><div class="flex-shrink-0"><img${add_attribute("src", school.logo.full_path, 0)} alt="" class="avatar-xs rounded-circle"></div> <h4 class="card-title mb-0 flex-grow-1"><span class="text-primary">${escape(school.name)}&#39;s</span> Students Management</h4></div> <div class="flex-shrink-0">${JSON.parse(sessionStorage.getItem("permissions")).includes("students.store") ? `<button type="button" data-bs-toggle="modal" data-bs-target="#addStudentModal" class="btn btn-primary waves-effect waves-light" data-svelte-h="svelte-3ylrul"><i class="ri-add-line align-bottom me-1"></i> Add Student</button> ${validate_component(AddStudentModal, "AddStudentModal").$$render($$result, { school }, {}, {})}` : ``}</div></div> ${JSON.parse(sessionStorage.getItem("permissions")).includes("students.index") ? `<div class="card-body"> <div class="row"> ${validate_component(SearchTable, "SearchTable").$$render($$result, { type: "Student" }, {}, {})} <div class="col-xl-3 mb-3"><select class="form-select" name="class" id="class" aria-label="Default select example"><option${add_attribute("value", "all", 0)} data-svelte-h="svelte-13f2t2c">All</option><option${add_attribute("value", "archived", 0)} data-svelte-h="svelte-1q69t1u">Archived</option><option${add_attribute("value", "not archived", 0)} data-svelte-h="svelte-aygy80">Not Archived</option></select></div> <div class="col-xl-3 mb-3"><select class="form-select" name="class" id="class" aria-label="Default select example"><option${add_attribute("value", "all", 0)} data-svelte-h="svelte-13f2t2c">All</option><option${add_attribute("value", "subscribed", 0)} data-svelte-h="svelte-1r4nn6a">Subscribed</option><option${add_attribute("value", "not subscribed", 0)} data-svelte-h="svelte-17v6sc">Not Subscribed</option></select></div>  ${validate_component(StudentsTable, "StudentsTable").$$render($$result, { studentsList, school }, {}, {})} ${validate_component(Pagination, "Pagination").$$render($$result, Object.assign({}, studentsPagination), {}, {})} </div>   </div>` : ``} </div></div> </div> `;
});

export { Page as default };
//# sourceMappingURL=_page.svelte-3ea7951f.js.map
