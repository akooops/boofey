...
<tr scope="row">
    ...
    <td>
        <div class="hstack gap-3 flex-wrap">
            <span data-bs-toggle="modal"><a href="/admin/subs/{sub.id}/subscriptions" class="fs-15" data-bs-toggle="tooltip" data-bs-original-title="Subscribtion" ><i class="ri-money-dollar-circle-line"></i></a></span>
