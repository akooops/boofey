<script>
    ...
    async function deleteTarget(){
        ...
        let res = await fetch(PathDelCanteenUser($canteenUserStore.id),{
            headers:{
        ...
        <div class="modal-content">
            <div class="modal-body text-center p-5">
                ...
                <div class="mt-2">
                    ...
                    <p class="text-muted fs-15 mb-4">Are you Sure You want to Delete <span class="text-primary">{`${$canteenUserStore.name} #${$canteenUserStore.id}`}</span> ?</p>
