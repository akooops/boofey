<script>
    import {PathDelUser} from "$lib/api/paths.js"
...
loading = true
        ...
        if(res.status == "success"){
            close.click()
            let text = `Deleted ${$userStore.username} #${$userStore.id}` 
            toast(text,"success")
...
<div id="deleteUserModal" class="modal fade" tabindex="-1" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-dialog-centered">
        ...
        <div class="text-end">
                ...
                <div class="mt-2" class:d-none={loading}>
                    ...
                    <p class="text-muted fs-15 mb-4">Are you Sure You want to Delete <span class="text-primary">{`${$userStore.username} #${$userStore.id}`}</span> ?</p>
