<script>
    import {PathDelCanteen} from "$lib/api/paths.js"
    ...
    async function deleteTarget(){
        ...
        let res = await (await fetch(PathDelCanteen($canteenStore.id),{method:"DELETE"})).json()
...
<div id="deleteCanteenModal" class="modal fade" tabindex="-1" aria-hidden="true" style="display: none;">
