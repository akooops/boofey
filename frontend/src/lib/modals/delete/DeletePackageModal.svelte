<script>
    import {PathDelPackage} from "$lib/api/paths.js"
    ...
    async function deleteTarget(){
        ...
        let res = await (await fetch(PathDelPackage($packageStore.id),{method:"DELETE"})).json()
...
<div id="deletePackageModal" class="modal fade" tabindex="-1" aria-hidden="true" style="display: none;">
