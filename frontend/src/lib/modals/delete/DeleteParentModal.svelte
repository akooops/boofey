<script>
    import {PathDelParent} from "$lib/api/paths.js"
...
<div id="deleteParentModal" class="modal fade" tabindex="-1" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-dialog-centered">
        ...
        <div class="text-end">
                ...
                <div class="mt-2" class:d-none={loading}>
                    ...
                    <p class="text-muted fs-15 mb-4">Are you Sure You want to Delete <span class="text-primary">{`${$parentStore?.user?.username} #${$parentStore.id}`}</span> ?</p>
