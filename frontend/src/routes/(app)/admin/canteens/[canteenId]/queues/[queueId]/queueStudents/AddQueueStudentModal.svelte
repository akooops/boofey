<script>
    ...
    import StudentsTableCollapse from "./StudentsTableCollapse.svelte"; 
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" >
                        ...
                        <div class="row g-3" class:d-none={loading}>
                            <!-- Base Example -->
                                    <StudentsTableCollapse collapse={true} on:select={(e) => studentId = e.detail.studentId} title={"Students"} subscribed={true} archived={false} schoolId={queue?.canteen?.school?.id} bind:resetStudent/>            
