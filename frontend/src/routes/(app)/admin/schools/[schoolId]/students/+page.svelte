        ...
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <div class="d-flex gap-2 align-items-center flex-grow-1">
                    ...
                    <h4 class="card-title mb-0 flex-grow-1"><span class="text-primary">{school.name}'s</span> Students Management</h4>
                </div>
                <div class="flex-shrink-0">
            ...
            <div class="card-body">
                ...
                <!-- <div class="live-preview"> -->
                    <div class="row">
                        ...
                        <StudentsTable {studentsList} {school}/>
